...
if (!password) {
  console.error('Usage: node scripts/generate-password.js <password> [optional_salt]');
...
console.log(`CATALOG_OWNER_USERNAME="owner"`);
console.log(`CATALOG_OWNER_SALT="${salt}"`);
console.log(`CATALOG_OWNER_PWD="${hash}"\n`);
