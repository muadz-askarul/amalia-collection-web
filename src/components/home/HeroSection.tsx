                ...
                <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                    ...
                    <div className="text-center lg:text-left">
                        ...
                        <div className="inline-flex items-center gap-2 bg-surface rounded-full px-4 py-2 shadow-sm mb-6">
                            ...
                            <span className="text-sm font-medium text-text-muted">Dipercaya 10+ Tahun</span>
                        </div>

                        <h1 className="font-heading font-bold text-4xl md:text-5xl lg:text-6xl text-text leading-tight mb-4">
                            Tidur Nyenyak, <span className="text-primary">Harga Bersahabat</span>
                        </h1>

                        <p className="text-text-muted text-lg md:text-xl leading-relaxed mb-8 max-w-lg mx-auto lg:mx-0">
                            Temukan kasur / matras, dan bantal berkualitas pilihan keluarga Indonesia. Tersedia
                            berbagai ukuran dan merek terpercaya.
                        </p>
                    ...
                    <div className="relative">
                        <div className="relative bg-gradient-to-br from-primary/10 to-accent-light/20 rounded-3xl p-8 md:p-12 aspect-square flex items-center justify-center">
                            <div className="text-center">
                                <div className="w-32 h-32 mx-auto mb-6 bg-surface rounded-full flex items-center justify-center shadow-lg">
                                    <img
                                        src="/logo_webp.webp"
                            ...
                            >
                                <p className="text-sm font-semibold text-primary">🛏️ Kasur Inoac</p>
                            </div>
                            <div
