import { Handshake, Phone, MapPin } from "lucide-react";
...
export default function KerjasamaPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <div className="bg-linear-to-br from-accent/10 via-background to-primary/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 text-center">
          ...
          <p className="text-text-muted text-lg max-w-2xl mx-auto">
            Tertarik untuk menjadi mitra Amalia Collection? Kami membuka
            kesempatan kerjasama untuk mengembangkan bisnis bersama.
          </p>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className="text-text-muted leading-relaxed mb-8">
              Untuk informasi lebih lanjut mengenai program kerjasama, silakan
              hubungi kami melalui WhatsApp atau datang langsung ke toko kami.
            </p>
          ...
          {/* CTA Card */}
          <div className="bg-linear-to-br from-accent/5 to-primary/5 border border-border rounded-2xl p-8 flex flex-col justify-center items-center text-center">
            <WhatsAppIcon size={40} className="text-[#25D366] mb-4" />
            <h3 className="font-heading font-semibold text-text text-xl mb-3">
              Chat via WhatsApp
            </h3>
            <p className="text-text-muted text-sm mb-6 max-w-xs">
              Cara tercepat untuk berdiskusi tentang peluang kerjasama bersama
              kami
            </p>
            <a
